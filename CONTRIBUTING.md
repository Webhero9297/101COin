Contributing to 101coin Core
============================

The 101coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the 101coin Core project, and is not to be
confused with overall 101coin Network Protocol consensus changes.

Whether a pull request is merged into 101coin Core rests with the project merge
...
Patches that change 101coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the 101coin consensus, it must have been
...
The project leader is the release manager for each 101coin Core release.
