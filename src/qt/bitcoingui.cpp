                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("101coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a 101coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and 101coin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About 101coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about 101coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for 101coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your 101coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified 101coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a 101coin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the 101coin Core help message to get a list with possible 101coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("101coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 101coin network", "", count));
}
...
{
    QString strTitle = tr("101coin Core"); // default title
