...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case I0I:
        return QString("101coin");
    case m101:
        return QString("m101coin");
    case u101:
        return QString::fromUtf8("u101coin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case u101:
            return QString("Micro-101 (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        ...
        case u101:
            return QString("Micro-Test101 (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
