...
/* 101x GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "101coin"
#define QAPP_ORG_DOMAIN "101coin.one"
#define QAPP_APP_NAME_DEFAULT "101coin-Qt"
#define QAPP_APP_NAME_TESTNET "101coin-Qt-testnet"
