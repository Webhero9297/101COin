...
public:
    ...
    bool WriteZ101Seed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZ101Seed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZ101Seed_deprecated(uint256& seed);
    bool EraseZ101Seed();
    bool EraseZ101Seed_deprecated();

    bool WriteZ101Count(const uint32_t& nCount);
    bool ReadZ101Count(uint32_t& nCount);
