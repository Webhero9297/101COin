...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("101x Core 101coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  101coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded 101coin transaction") + "\n" +
                               "  101coin-tx [options] -create [commands]   " + _("Create hex-encoded 101coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded 101coin transaction
