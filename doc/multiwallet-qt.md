...
In order to support loading of multiple wallets in 101coin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is 101coin.cpp.
...
Changes to 101coin.cpp
----------------------
101coin.cpp is the entry point into 101coin-qt, and as such, will require some minor modifications to provide hooks for
