...
class MempoolCoinbaseTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        spend_a101_raw = self.create_tx(coinbase_txids[0], node1_address, 50)
        ...
        spend_a101_id = self.nodes[0].sendrawtransaction(spend_a101_raw)
        spend_102_1_id = self.nodes[0].sendrawtransaction(spend_102_1_raw)

        self.sync_all()

        assert_equal(set(self.nodes[0].getrawmempool()), set([ spend_a101_id, spend_102_1_id ]))
