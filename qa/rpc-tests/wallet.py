...
#   c) node1 mines 32 blocks, so now node 0 has 60001101, node 1 has 4250101, node2 has none.
#   d) node0 sends 601 101 to node2, in two transactions (301 101, then 300 101).
