...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("101coincoin.io", "seed.101coincoin.io"));     // Primary DNS Seeder 
        ...
        strSporkKey = "04a8a044f09af21416d2b11dbeb06daa058f183f1b551a5e1ea38a4fed00978afc9f120332636eeb3de42892116220ba55d00e530e3fbdaa2040603ac5d1ad8d33";
        // TODO
        strObfuscationPoolDummyAddress = "D87q2gC9j6nNrnzCsg4aY6bHMLsT9nUhEw";
        nStartMasternodePayments = 1528662766; 
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 24 * 60 * 60; // 101coin: 1 day
        nTargetSpacing = 1 * 90;  // 101coin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        // nEnforceNewSporkKey = 1521604800; // removed
        // nRejectOldSporkKey = 1522454400; // removed
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "101coin-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "101coin-testnet.seed2.fuzzbawls.pw"));
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // 101coin: 1 day
        nTargetSpacing = 1 * 60;        // 101coin: 1 minutes
