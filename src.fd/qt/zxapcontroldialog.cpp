...
#include "z101controldialog.h"
#include "ui_z101controldialog.h"
...
std::set<std::string> Z101ControlDialog::setSelectedMints;
std::set<CMintMeta> Z101ControlDialog::setMints;

Z101ControlDialog::Z101ControlDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Z101ControlDialog),
    model(0)
{
    ui->setupUi(this);
    setMints.clear();
...
Z101ControlDialog::~Z101ControlDialog()
{
    delete ui;
}

void Z101ControlDialog::setModel(WalletModel *model)
{
    this->model = model;
    updateList();
}
...
void Z101ControlDialog::updateList()
{
...
void Z101ControlDialog::updateSelection(QTreeWidgetItem* item, int column)
{
...
void Z101ControlDialog::updateLabels()
{
    int64_t nAmount = 0;
    for (const CMintMeta& mint : setMints) {
    ...
    ui->labelZ101_int->setText(QString::number(nAmount));
    ui->labelQuantity_int->setText(QString::number(setSelectedMints.size()));

}

std::vector<CMintMeta> Z101ControlDialog::GetSelectedMints()
{
...
void Z101ControlDialog::ButtonAllClicked()
{
    ui->treeWidget->blockSignals(true);
