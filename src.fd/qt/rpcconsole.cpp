                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strz101PathCustom = GetArg("-z101backuppath", "");
    ...
    if(!strz101PathCustom.empty()) {
        ui->wallet_customz101backuppath->setText(QString::fromStdString(strz101PathCustom));
        ui->wallet_customz101backuppath_label->setVisible(true);
        ui->wallet_customz101backuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strz101PathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the 101coin RPC console.") + "<br>" +
