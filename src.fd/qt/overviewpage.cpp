...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::101)
    {
    }
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    CAmount 101AvailableBalance = balance - immatureBalance;
    ...
    // 101 labels
    ui->labelBalance->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, 101AvailableBalance, false, BitcoinUnits::separatorAlways));
    ...
    bool show101Available = settingShowAllBalances || 101AvailableBalance != nTotalBalance;
