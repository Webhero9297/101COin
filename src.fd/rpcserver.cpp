...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "101coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* 101coin features */
        {"101coin", "masternode", &masternode, true, true, false},
        {"101coin", "listmasternodes", &listmasternodes, true, true, false},
        {"101coin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"101coin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"101coin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"101coin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"101coin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"101coin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"101coin", "masternodedebug", &masternodedebug, true, true, false},
        {"101coin", "startmasternode", &startmasternode, true, true, false},
        {"101coin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"101coin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"101coin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"101coin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"101coin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"101coin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"101coin", "mnsync", &mnsync, true, true, false},
        {"101coin", "spork", &spork, true, true, false},
        {"101coin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> 101coin-cli " + methodname + " " + args + "\n";
}
